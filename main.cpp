/* author: Mahesh Gaya
*  date: 20 April, 2015
*  description:  use of hash table to analyze a movie review (sentiment analysis)
*  improvement: The program reads every single characters in the movieReview.txt. Some of them do not make sense, e.g. period(.), comma(,) and other such characters. Moreover, one way to improve the performance and provide a better analysis is to assign each word to either Bad or Good. In that way, it will make more sense that the word the user is searching for is either bad or good.
*/
